  ...
  const content = {
    ...
    zh: {
      ...
      strengths: {
        title: "我们的优势",
        items: [
          { icon: Globe, title: "全球供应链", desc: "与韩国、美国、德国、日本、中国等地知名制造商和代理商建立合作关系。" },
          { icon: Package, title: "库存充足", desc: "香港、深圳仓库库存充足，与众多现货分销商战略联盟，保证供应稳定。" },
          { icon: Zap, title: "一站式采购", desc: "消除多方结算和对账的麻烦，简化整个采购流程。" }
        ]
      },
      products: {
        title: "我们的产品",
        ...
        items: [
          ...
          { title: "无源器件", desc: "电阻、电容、电感，优质品质" },
          { title: "分立器件", desc: "二极管、晶体管、MOSFET 等多种应用" },
      ...
      solutions: {
        ...
        items: [
          ...
          { title: "汽车行业", desc: "智能出行。安全驾驶。支持电动汽车和自动驾驶技术。" },
          { title: "工业设备", desc: "优化运营。为工业赋能。推动制造和自动化。" },
          { title: "智能设备", desc: "智能科技。互联互通。推动物联网和智能家居。" }
        ]
      },
      services: {
        title: "核心服务",
        items: [
          { icon: Zap, title: "BOM 配单服务", desc: "提供 400+ 全球品牌产品，解决各类元器件难采购问题。" },
          { icon: Package, title: "循环订货备货", desc: "帮助客户降低生产/采购成本，缓解资金压力。" },
          { icon: Package, title: "样品及小批量服务", desc: "满足研发及小批试产单位的需求。" },
          { icon: Truck, title: "库存积压品回收", desc: "最大化残值，灵活周转资金。" }
        ]
      },
      valueAdded: {
        title: "增值服务与支持",
        subtitle: "专业技术支持和增值服务，为您的业务保驾护航",
        items: [
          { icon: Headphones, title: "技术支持", desc: "产品规格、应用指南、变更通知" },
          { icon: Shield, title: "专业处理", desc: "编带服务、重新卷盘、SMT 生产线" },
          { icon: Award, title: "质量保证", desc: "代理检验服务、经验丰富的员工、可靠的质量" },
          { icon: Zap, title: "自产变压器", desc: "龙岗工厂、高质量、有竞争力的价格" }
        ]
      },
      expertise: {
        title: "专家团队",
        subtitle: "深厚的行业知识和成熟的经验",
        highlights: [
          { number: "50+", label: "专业工程师" },
          { number: "20+", label: "平均从业年限" },
          { number: "100+", label: "成功项目" }
        ],
        values: [
          { icon: Users, title: "协作", desc: "我们携手合作，共同成就更多。" },
          { icon: Zap, title: "创新", desc: "我们挑战现状，创造更好的解决方案。" },
          { icon: Shield, title: "专业", desc: "深厚的技术知识。成熟的行业经验。" },
          { icon: CheckCircle2, title: "信任", desc: "诚信、可靠、承诺，贯穿一切。" }
        ]
      },
      partnership: {
        title: "合作共赢",
        subtitle: "携手合作，共创美好未来，实现互利共赢",
        items: [
          { title: "长期合作", desc: "与全球知名制造商和代理商建立稳定的合作关系" },
          { title: "互利共赢", desc: "提供专业的技术支持和优质的服务，帮助客户业务增长" },
      ...
      <nav className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="container flex items-center justify-between py-4">
          <div className="flex items-center gap-3">
            <img
              src="https://d2xsxph8kpxj0f.cloudfront.net/310419663032166958/K2fXVoNC4ffPac84a64vSx/szjqdz-logo-5rnaguf5J7bKJjF45ZziKB.webp"
              alt="SZJQDZ Logo"
